...
METADATA_COLUMNS = [
    ...
    'problemcause', 'solutioncategory', 'language', 'failureclass', 'date'
]
...
# Remove empty text entries & duplicates
combined_df = combined_df[combined_df['observation'] != ''].drop_duplicates(subset=['observation', 'project']).reset_index(drop=True)
